...
class StructureStartUrl(object):
    ...
    def get_topic_id(self):
        topic_id_list = []
        sql = 'SELECT DISTINCT(topic_id) FROM `auto_home_club_topic_list` WHERE post_topic_date > "2019-01-01" ORDER BY topic_id '
...
if __name__ == "__main__":
    ...
    print(StructureStartUrl.get_bbs_topic_id()[0])